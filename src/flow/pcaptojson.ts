...
export class PCAPToJSON{
    ...
    public static async TransformToJSON(pcapPath:string, outputDirectory:string, secretsPath?:string):Promise<string> {
        ...
        let output:Promise<string> = new Promise<string>( (resolver, rejecter) => {
            ...
            let timeoutMin = 1;
            let tsharkLocation:string = "/wireshark/run/tshark";
